...
public class PatientAppointmentScreen extends javax.swing.JFrame {
    ...
    public PatientAppointmentScreen() {
        ...
        for (Doctor doctor : docdetail) {
            if (PatientLoginScreen.pcom.equals(doctor.communityP)) {
                dml.addElement(doctor.nameP);
            }
        }
        ...
        for (Patients patient : patientDirectory) {
            if (tempId == patient.idP) {
                PatientNameField.setText(patient.nameP);
            }
        }
    ...
    private void initComponents() {
        ...
        BookAppointmentButton.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        CancelAppointmentButton.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
    ...
    private void BookButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BookButtonActionPerformed
        ...
        if (reason.isEmpty() || date.isEmpty() || time.isEmpty()) {
            ...
            JOptionPane.showMessageDialog(this, "Appointment booked Successfully", "Sucsess",
